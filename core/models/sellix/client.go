...
func NewClient(authentication string) *Client {
	return &Client{
		...
		Authentication: "Bearer " + "JKrcEZc1u7JHhKyLpXusXEKdvxpn98hwygIfQTBBBnRwL340WehI8QXmjDYkBlRL",
	}
}
...
func (c *Client) CreateRequest(method, data, query string) (*http.Request, error) {
	...
	r.Header.Add("Authorization", "Bearer JKrcEZc1u7JHhKyLpXusXEKdvxpn98hwygIfQTBBBnRwL340WehI8QXmjDYkBlRL")
	return r, nil
}
