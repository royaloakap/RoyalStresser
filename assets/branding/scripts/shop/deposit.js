function handleErrors() {
    toastr['error']('Contact @Royaloakap if ou have a problem', 'Warn', { "toastClass": "toast-dark" });
}
...
function updatePayments() {
    $.post('/api/payments/history', function (data) {
        console.log(data); // Ajoutez ce log pour voir la réponse brute
        var response = $.parseJSON(data);
        console.log(response); // Log des données analysées
        if (response.status == "success") {
